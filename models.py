...
class UpsPluginSettings(models.Model):
    ...
    check_kind = models.CharField(max_length=20, choices=CHECK_CHOICES, default=CHECK_ALWAYS_ON)

    # check_kind = gpio
    gpio_pin = models.IntegerField(default=17, help_text="BCM-Pin-Nummer, nur für 'GPIO-Pin'.")
    ...
    poll_interval_s = models.IntegerField(default=5, help_text="Wie oft der Status geprüft wird.")
    ...
    last_power_status = models.CharField(max_length=100, blank=True, default="")
